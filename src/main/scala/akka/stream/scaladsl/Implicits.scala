...
object Implicits {
  ...
  implicit def fanin22Hlist[I0, I1, O, M](fanin: Graph[FanInShape2[I0, I1, O], M]): HListGraph[::[Inlet[I0], ::[Inlet[I1], HNil]], ::[Outlet[O], HNil], M] =
    HListGraph.fromGraph(GraphDSL.create(fanin){_ => s => HListShape(s.in0 :: s.in1 :: HNil, s.out :: HNil)})
